...
export default function GlobeDemo({ className }: { className?: string }) {
  ...
  return (
    <div
      className={
        "flex flex-row items-center justify-center py-20 h-[30rem] sm:h-screen md:h-auto dark:bg-black bg-white relative w-full " +
        className
      }
    >
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full  md:h-[60rem] px-4">
        ...
        >
          <h2 className="text-center text-xl md:text-4xl font-bold text-black dark:text-white">
            We sell Gamming Accounts worldwide
          </h2>
          <p className="text-center text-base md:text-lg font-normal text-neutral-700 dark:text-neutral-200 max-w-md mt-2 mx-auto">
            Top 1% Gaming Accounts. :)
          </p>
        </motion.div>
