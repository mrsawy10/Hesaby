...
import { deleteFaq } from "@/actions/admin/faq";

//

const BodyComponentRenderFunction = (ele: { question: string; answer: string; id: string }) => {
  //
          ...
          <div className="flex items-center gap-4 ">
            <div>
              ...
              <Tooltip content="Edit " color="secondary">
                <Link href={`/dashboard/faq/${ele?.id}`}>
                  <button>
              ...
              action={async () => {
                ...
                try {
                  ...
                  if (result.isConfirmed) {
                    ...
                    let deletedGame = await deleteFaq(ele?.id);
                    // setIsLoading(false);
